    ...
    public void tableload(){
     ...
     public void print (){
       int id = Integer.parseInt(searchbox.getText());
            ...
            JasperDesign jdesign = JRXmlLoader.load("G:\\sanasabaanksytem\\src\\reports\\memberacc.jrxml");
    ...
    private void printbtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_printbtnActionPerformed
        if(searchbox.getText().isEmpty()){
            ...
            if(id>=1 && id<=500){
                ...
                JOptionPane.showMessageDialog(null, "The Child ID can only use number 1 to 500.");
            }
