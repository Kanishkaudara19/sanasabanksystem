 ...
 * @author acer
 */
public class maccounttable extends javax.swing.JInternalFrame {
    ...
    ResultSet rs = null;
    /**
     * Creates new form maccounttable
     */
    public maccounttable() {
        initComponents();
    ...
    private void theader(){
        JTableHeader thead = macctable.getTableHeader();
    ...
    public void tableload(){
        try {
            String sql = "SELECT * FROM memberacc";
            
            pst =con.prepareStatement(sql);
            rs = pst.executeQuery();
            macctable.setModel(DbUtils.resultSetToTableModel(rs));
            macctable.setBackground(Color.LIGHT_GRAY);
            macctable.setFont(new Font("Times New Roman", Font.BOLD, 13));
           theader();
        } catch (Exception e) {
     ...
     public void print (){
       int id = Integer.parseInt(searchbox.getText());
            ...
            JasperDesign jdesign = JRXmlLoader.load(currentDirectory + "\\src\\reports\\memberacc.jrxml");
    ...
    String srch = searchbox.getText();
        try {
         String sql = "SElECT * FROM memberacc WHERE accno='"+srch+"'"; 
          pst = con.prepareStatement(sql);
         rs = pst.executeQuery();
         macctable.setModel(DbUtils.resultSetToTableModel(rs));
        } catch (Exception e) {
    ...
    private void initComponents() {
        ...
        macctable = new javax.swing.JTable();
        ...
        jLabel1.setText("Member Account Details");
        ...
        macctable.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {null, null, null, null},
                {null, null, null, null},
                {null, null, null, null},
        ...
        jScrollPane1.setViewportView(macctable);
    ...
    private void printbtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_printbtnActionPerformed
        if(searchbox.getText().isEmpty()){
            ...
            if(id>=1 && id<=500){
                ...
                JOptionPane.showMessageDialog(null, "The Child ID can only use number 1 to 500.", "Error", JOptionPane.ERROR_MESSAGE);
            }
    ...
    private javax.swing.JTable macctable;
