...
public class loanpaytable extends javax.swing.JInternalFrame {
    ...
    private void theader(){
        JTableHeader thead = loanpaytable.getTableHeader();
    ...
    public void tableload(){
        try {
            String sql = "SELECT memberid,loanid,name,nicno,paid_amount,current_loan,date,time FROM loanpay";
            
            pst =con.prepareStatement(sql);
            rs = pst.executeQuery();
            loanpaytable.setModel(DbUtils.resultSetToTableModel(rs));
            loanpaytable.setBackground(Color.LIGHT_GRAY);
    ...
    String srch = searchbox.getText();
        try {
         String sql = "SElECT * FROM loanpay WHERE memberid = '"+srch+"'"; 
          pst = con.prepareStatement(sql);
         rs = pst.executeQuery();
         loanpaytable.setModel(DbUtils.resultSetToTableModel(rs));
        } catch (Exception e) {
    ...
    private void initComponents() {
        ...
        loanpaytable = new javax.swing.JTable();
        ...
        jLabel1.setText("Loan Payment Details");

        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Images/sanasa2.png"))); // NOI18N

        jPanel3.setBackground(new java.awt.Color(204, 204, 204));
        jPanel3.setBorder(javax.swing.BorderFactory.createTitledBorder("Please Enter Member ID"));
        ...
        searchbtn.setBounds(180, 30, 90, 30);
        ...
        reportbtn.setBounds(290, 30, 100, 30);
        ...
        printbtn.setBounds(400, 30, 90, 30);

        loanpaytable.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {null, null, null, null},
                {null, null, null, null},
                {null, null, null, null},
        ...
        jScrollPane1.setViewportView(loanpaytable);
    ...
    private javax.swing.JTable loanpaytable;
