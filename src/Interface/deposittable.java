...
public class deposittable extends javax.swing.JInternalFrame {
    ...
    private void theader(){
        JTableHeader thead = deposittable.getTableHeader();
    ...
    public void tableload(){
        try {
            String sql = "SELECT accno,name,amount,balance,acc_type,date,time FROM deposit";
            
            pst =con.prepareStatement(sql);
            rs = pst.executeQuery();
            deposittable.setModel(DbUtils.resultSetToTableModel(rs));
            deposittable.setBackground(Color.LIGHT_GRAY);
            deposittable.setFont(new Font("Times New Roman", Font.BOLD, 13));
           theader();
        } catch (Exception e) {
    ...
    String srch = searchbox.getText();
        try {
         String sql = "SElECT * FROM deposit WHERE accno = '"+srch+"'"; 
          pst = con.prepareStatement(sql);
         rs = pst.executeQuery();
         deposittable.setModel(DbUtils.resultSetToTableModel(rs));
        } catch (Exception e) {
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setIconifiable(true);
        setPreferredSize(new java.awt.Dimension(972, 626));
        ...
        jPanel3.setBorder(javax.swing.BorderFactory.createTitledBorder("Please enter account number"));
