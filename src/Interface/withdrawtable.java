...
public class withdrawtable extends javax.swing.JInternalFrame {
    ...
    ResultSet rs = null;
    /**
     * Creates new form withdrawtable
     */
    ...
    private void theader(){
        JTableHeader thead = withdrawtable.getTableHeader();
    ...
    public void tableload(){
        try {
            String sql = "SELECT accno,name,amount,balance,acc_type,date,time FROM withdraw";
            
            pst =con.prepareStatement(sql);
            rs = pst.executeQuery();
            withdrawtable.setModel(DbUtils.resultSetToTableModel(rs));
            withdrawtable.setBackground(Color.LIGHT_GRAY);
    ...
    String srch = searchbox.getText();
        try {
         String sql = "SElECT * FROM withdraw WHERE accno = '"+srch+"'"; 
          pst = con.prepareStatement(sql);
         rs = pst.executeQuery();
         withdrawtable.setModel(DbUtils.resultSetToTableModel(rs));
        } catch (Exception e) {
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setIconifiable(true);
        setPreferredSize(new java.awt.Dimension(976, 624));

        jPanel1.setBackground(new java.awt.Color(255, 255, 255));

        jLabel1.setFont(new java.awt.Font("Segoe UI", 1, 36)); // NOI18N
        jLabel1.setText("Withdraw Details");
